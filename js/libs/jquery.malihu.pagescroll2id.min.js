/* == Page scroll to id == Version: 1.5.8, License: MIT License (MIT) */ ! function(e, t, a) {
    var n, l, s, i, o, r, c, u, h, g, f, d, p = "mPageScroll2id",
        _ = "mPS2id",
        ...
        S = {
            init: function(r) {
                ...
                l.liveSelector && (this.selector += "," + l.liveSelector), n = n ? n + "," + this.selector : this.selector, l.defaultSelector && ("object" == typeof e(n) && 0 !== e(n).length || (n = C)), l.clickEvents && e(a).undelegate("." + _).delegate(n, "click." + _, function(t) {
                    if (I._isDisabled.call(null)) return void I._removeClasses.call(null);
                    var a = e(this),
                        n = a.attr("href"),
                        l = a.prop("href");
                    n && -1 !== n.indexOf("#/") || (I._reset.call(null), g = a.data("ps2id-offset") || 0, I._isValid.call(null, n, l) && I._findTarget.call(null, n) && (t.preventDefault(), i = "selector", o = a, I._setClasses.call(null, !0), I._scrollTo.call(null)))
                    ...
                    t.each(function(a) {
                        ...
                        I._setClasses.call(null, !1, n, s), a == t.length - 1 && I._extendClasses.call(null)
                    })
        ...
        I = {
            ...
            _isValid: function(e, a) {
                if (e) {
                    ...
                    return "#" !== e && -1 !== e.indexOf("#") && ("" === n || decodeURIComponent(n) === decodeURIComponent(l))
                }
            },
            _setup: function() {
                ...
                return e(t).each(function() {
                    ...
                    if (I._isValid.call(null, i, o)) {
                        var r = -1 !== i.indexOf("#/") ? i.split("#/")[1] : i.split("#")[1],
                            c = e("#" + r);
                        if (c.length > 0) {
                            l.highlightByNextTarget && c !== n && (n ? n.data(_, {
                                tn: c
                            }) : c.data(_, {
                                tn: "0"
            ...
            _findTarget: function(t) {
                ...
                return r = n, u || (u = l.layout), h = I._setOffset.call(null), c = [(n.offset().top - h[0]).toString(), (n.offset().left - h[1]).toString()], c[0] = c[0] < 0 ? 0 : c[0], c[1] = c[1] < 0 ? 0 : c[1], c
            },
            _setOffset: function() {
            ...
            _findHighlight: function(a) {
                var n = t.location,
                    ...
                    s = n.pathname;
                return e("._" + _ + "-h[href='#" + a + "'],._" + _ + "-h[href='" + l + "#" + a + "'],._" + _ + "-h[href='" + s + "#" + a + "'],._" + _ + "-h[href='#/" + a + "'],._" + _ + "-h[href='" + l + "#/" + a + "'],._" + _ + "-h[href='" + s + "#/" + a + "']")
            },
            _setClasses: function(t, a, n) {
                var s = l.clickedClass,
                    i = l.targetClass,
                    r = l.highlightClass;
                t && s && "" !== s ? (e("." + s).removeClass(s), o.addClass(s)) : a && i && "" !== i && n && r && "" !== r && (I._currentTarget.call(null, a) ? (a.addClass(i), n.addClass(r)) : (!l.keepHighlightUntilNext || e("." + r).length > 1) && (a.removeClass(i), n.removeClass(r)))
            },
            ...
            _currentTarget: function(a) {
                ...
                if (l.highlightByNextTarget) {
                    ...
                    if (y) {
                        ...
                        "vertical" === l.layout ? b = [i.top <= f / 2, w.top > f / 2, 1, 1] : "horizontal" === l.layout && (b = [1, 1, i.left <= d / 2, w.left > d / 2])
                    }
                }
                return b[0] && b[1] && b[2] && b[3]
            },
            _scrollTo: function() {
                d = I._scrollSpeed.call(null), c = l.pageEndSmoothScroll ? I._pageEndSmoothScroll.call(null) : c;
                var a = e("html,body"),
            ...
            _live: function() {
                f = setTimeout(function() {
                    l.live ? e(I._highlightSelector()).length !== m && I._setup.call(null) : f && clearTimeout(f), I._live.call(null)
                }, 1e3)
            },
            _easing: function() {
                function t(e) {
